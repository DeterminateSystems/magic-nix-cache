// Vendored from attic: https://github.com/DeterminateSystems/attic/tree/83c742229584d4bfc8106b7a1fc4b64ea02c30f1/server/src/narinfo
...
use attic::hash::Hash;
use nix_manifest::SpaceDelimitedList;
